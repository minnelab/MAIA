...
def copy_certificate_authority_secret(
    namespace, source_secret_name="kubernetes-ca", target_secret_name="kubernetes-ca", source_namespace="cert-manager", opaque=False, cert_name="tls.crt", key_name="tls.key"
):
