...
![Version](https://img.shields.io/github/v/tag/minnelab/MAIA?label=MAIA&color=blue&sort=semver&include_prereleases&filter=v*)
...
![Ansible Collection Version](https://img.shields.io/github/v/tag/minnelab/MAIA?label=maia.installation&color=blue&sort=semver&include_prereleases&filter=ansible-maia.installation-v*)
