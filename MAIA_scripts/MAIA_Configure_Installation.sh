...
CORE_PROJECT_VERSION=$(python -c "from MAIA.versions import define_maia_core_versions; print(define_maia_core_versions()['core_project_chart_version'])")
...
ADMIN_PROJECT_VERSION=$(python -c "from MAIA.versions import define_maia_admin_versions; print(define_maia_admin_versions()['admin_project_chart_version'])")
